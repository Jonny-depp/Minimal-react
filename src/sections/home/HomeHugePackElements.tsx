...
const StyledContent = styled("div")(({ theme }) => ({
  ...bgGradient({
    color: alpha(
      ...
      theme.palette.mode === "light" ? 0.9 : 0.98
    ),
    ...
    <StyledContent>
      ...
      <StyledRow>
        ...
        <m.div variants={varFade().in}>
          <Chip
            color="warning"
            onDelete={() => {}}
            avatar={<CustomAvatar name={String(_mock.image.avatar(2))} />}
            label="Chip"
          />
        </m.div>
      </StyledRow>
      ...
      <StyledRow>
        ...
        <m.div variants={varFade().in}>
          <CustomAvatarGroup>
            {[...Array(8)].map((_, index) => (
              <CustomAvatar key={index} name={_mock.image.avatar(index)} />
            ))}
          </CustomAvatarGroup>
        </m.div>
...
const ViewAllButton = (
  <m.div variants={varFade().inUp}>
    <Button
      ...
      rel="noopener"
      href=""
      endIcon={<Iconify icon="ic:round-arrow-righy-alt" />}
    >
      View All Componnts
    </Button>
  </m.div>
