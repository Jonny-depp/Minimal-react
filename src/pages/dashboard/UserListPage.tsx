...
import { UserTableToolbar, UserTableRow } from "../../sections/\
/dashboard/user/list";
...
export default function UserListPage() {
  ...
  const handleFilterStatus = ({ event, newValue }: any) => {
    setPage(0);
...
function applyFilter({
  ...
  if (filterStatus !== "all") {
    inputData = inputData.filter((user: any) => user.status === filterStatus);
  }
